...
var ImpressionList = {
  ...
  {
    var r = this,
      n = r.container.html(Brick.renderTpl("tag", e)),
      s = n.addClass("yx-tags-loading").all(".yx-tag"),
      a = s.length;
    s.each(function(e, r)
    {
      var s = this;
      setTimeout(function()
      {
        s.css("display", "inline-block").fadeIn(function() {}), r == a - 1 && n.removeClass("yx-tags-loading")
      }, (50 - r) * r++)
    })
  }
};
...
{
  var r = e.one;
  ImpressionList.container = KISSY.one("#yx-tags"), r("#J_refresh").on("click", function()
  {
    ImpressionList.get()
  })
});
