...
var ImpressionList = {
  ...
  {
    var me = this;
    KISSY.IO.get(me.api.get,
    {
      page: ++me.currentPage
    }, function(r)
    {
      eval("var r=" + r), r.success ? (me.render(r.data), r.hasMore || -1 == me.currentPage) : KISSY.log(r.errorMsg)
    })
  },
  render: function(e)
  {
    var n = this,
      r = n.container.html(Brick.renderTpl("tag", e)),
      t = r.addClass("yx-tags-loading").all(".yx-tag"),
      a = t.length;
    t.each(function(e, n)
    {
      var t = this;
      setTimeout(function()
      {
        t.css("display", "inline-block").fadeIn(function() {}), n == a - 1 && r.removeClass("yx-tags-loading")
      }, (50 - n) * n++)
    })
  }
};
KISSY.use("node,event,ajax", function(e)
{
  var n = e.one;
  ImpressionList.container = KISSY.one("#yx-tags"), n("#J_refresh").on("click", function()
  {
    ImpressionList.get()
  })
});
